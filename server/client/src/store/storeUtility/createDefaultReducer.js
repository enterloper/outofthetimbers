/**
 * This is a wrapper function used to create a reducer function to manage a particular section of the app state.
 * It accepts an optional initial state of the reducer and an actionMap to map the action({ payload, type })
 * that was fired to its appropriate action handler function.
 *
 * @export
